...
class PineconeVectorStore(VectorStore):
    ...
    def __init__(
        ...
        *,
        ...
        if index:
            ...
            _index_name = index_name or os.environ.get(
                "PINECONE_INDEX_NAME") or ""
            if not _index_name:
                raise ValueError(
    ...
    def get_pinecone_index(
        ...
        *,
        ...
        _pinecone_api_key = pinecone_api_key or os.environ.get(
            "PINECONE_API_KEY") or ""
        client = PineconeClient(
    ...
    def from_texts(
        ...
        **kwargs: Any,
        ...
        pinecone = cls(pinecone_index, embedding,
                       text_key, namespace, **kwargs)
    ...
    def delete(
        ...
        **kwargs: Any,
        ...
        if delete_all:
            ...
            raise ValueError(
                "Either ids, delete_all, or filter must be provided.")
